...
class _Punto1State extends State<Punto1> {
  ...
  Widget build(BuildContext context) {
    ...
    String texto = 'Tipo: ${preguntaxd[0]}\nAutor: ${preguntaxd[1]}\nNombre del texto: ${preguntaxd[2]}\nTexto: ${preguntaxd[3]}';
  ...
  child: Container(
    ...
    color: Colors.transparent,
    child: Center(
      child: SingleChildScrollView(  // Agregar un widget de desplazamiento
        child: Text(
          ...
          softWrap: true,  // Permitir que el texto se ajuste a nuevas líneas
        ),
      ),
    ),
  ),
